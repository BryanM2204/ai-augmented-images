...
#SBATCH --output=logs/sort_%j.out   # Standard output log (%j inserts JobID)
...
echo "Starting sorting of Defactify dataset..."
python ../../preprocess/sort_defactify.py

echo "Sorting completed. Check logs for details."