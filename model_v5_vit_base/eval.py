...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("/home/bam20007/ai-augmented-images/checkpoints/vit_base_16_384_aggressive_regularization/best_vit_model.pth", weights_only=True))
    model.to(device)
